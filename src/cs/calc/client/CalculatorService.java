 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://server.calc.cs/", wsdlLocation = "http://localhost:8090/calcservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://server.calc.cs/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/calcservice?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://server.calc.cs/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.calc.cs/", "CalculatorPort"), Calculator.class, features);
    }
